...
import './AddNews.css';  // You can create this file for styling
...
const AddNews = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    newsData.append('news_img', formData.news_img);  // Append the file
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setImagePreview(''); // Reset image preview after submission
      }
    } catch (error) {
